...
//        }
    ...
    public void updateRecordButton(TLRPC.Chat chat, TLRPC.UserFull userFull) {
        ...
        audioVideoSendButton.setColorFilter(new PorterDuffColorFilter(audioVideoButtonContainerForbidden ?
            getThemedColor(Theme.key_glass_defaultIcon) : getThemedColor(Theme.key_chat_messagePanelSendIcon), PorterDuff.Mode.SRC_IN));
...
//            }
    ...
    public static class SendButton extends View {
        ...
        public void updateColors() {
            int color = (isNewDesignSendButton || shouldDrawBackground()) ? Theme.getColor(Theme.key_chat_messagePanelSendIcon, resourcesProvider) : Theme.getColor(Theme.key_chat_messagePanelSend, resourcesProvider);
