...
public class UpdaterUtils {
    ...
    private static final String RELEASE_URI = "https://api.github.com/repos/GominMessenger/Gomin/releases/latest";
    private static final String BETA_URI = "https://api.github.com/repos/GominMessenger/Gomin/releases/latest";
